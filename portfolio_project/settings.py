...
SECRET_KEY='portfolio-dev';DEBUG=True;ALLOWED_HOSTS=['127.0.0.1','localhost']
...
LANGUAGE_CODE='en-us';TIME_ZONE='Asia/Kolkata';USE_I18N=True;USE_TZ=True;STATIC_URL='/static/';STATICFILES_DIRS=[BASE_DIR/'static'];DEFAULT_AUTO_FIELD='django.db.models.BigAutoField';PORTFOLIO_ADMIN_CODE='dundi'
MEDIA_URL = '/media/'
